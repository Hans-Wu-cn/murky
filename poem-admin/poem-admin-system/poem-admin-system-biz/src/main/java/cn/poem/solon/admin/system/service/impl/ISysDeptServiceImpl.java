...
import cn.poem.solon.admin.system.mapper.SysDeptMapper;
...
public class ISysDeptServiceImpl extends ServiceImpl<SysDeptMapper, SysDept> implements ISysDeptService {
    ...
    @Inject
    private SysUserMapper poemUserMapper;
    ...
    public List<SysDeptTreeVO> treeDept() {
        ...
        List<SysDeptTreeVO> SysDeptTreeVOList = SysDeptConvert.INSTANCES.toEntity(allSysDept);
