<template>
    <div class="inputContent">
        ...
        <t-textarea v-else-if="props.type === 'textarea'" v-model="value" :placeholder="props.placeholder || '请输入'"></t-textarea>
        ...
        <deptTreeSelect v-else-if="props.type === 'deptTreeSelect'" v-model:value="value"></deptTreeSelect>
        <userSelect v-else-if="props.type === 'userSelect'" v-model:value="value"></userSelect>
    </div>
</template>
<script setup lang="ts">
import {useVModels} from '@vueuse/core';
import deptTreeSelect from '../../user/components/deptTreeSelect.vue';
