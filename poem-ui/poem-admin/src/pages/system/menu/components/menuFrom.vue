            ...
            <t-loading :loading="loading">
                <t-form ref="form" :rules="FORM_RULES" :data="menuFormData" :colon="true" @submit="onSubmit">
                    <t-row>
                        ...
                        <t-col :span="spanCol" v-if="menuFormData.type !== 2">
                            <t-form-item :label="$t('menu.label.name')" name="name">
                                <t-input :placeholder="$t('menu.label.pl.name')" v-model="menuFormData.name" />
                            </t-form-item>
                        </t-col>
                        <t-col :span="spanCol" v-if="menuFormData.type !== 2">
                            <t-form-item :label="$t('menu.label.icon')" name="icon">
                        ...
                        <t-col :span="spanCol" v-if="menuFormData.type !== 2">
                            <t-form-item :label="$t('menu.label.router')" name="path">
                                <t-input :placeholder="$t('menu.label.pl.router')" v-model="menuFormData.path" />
                            </t-form-item>
                        </t-col>
                        <t-col :span="spanCol" v-if="menuFormData.type === 1">
                            <t-form-item :label="$t('menu.label.compoment')" name="component">
                                <t-input :placeholder="$t('menu.label.pl.compoment')" v-model="menuFormData.component" />
                            </t-form-item>
                        </t-col>
                        <t-col :span="spanCol" v-if="menuFormData.type !== 0">
                            <t-form-item :label="$t('menu.label.from.auth')" name="auth">
                                <t-input :placeholder="$t('menu.label.from.pl.auth')" v-model="menuFormData.auth" />
                            </t-form-item>
                        </t-col>
                        <t-col :span="spanCol" v-if="menuFormData.type === 1">
                            <t-form-item :label="$t('menu.label.query')" name="query">
                                <t-input :placeholder="$t('menu.label.pl.query')" v-model="menuFormData.query" />
                            </t-form-item>
                        </t-col>
                        <t-col :span="spanCol" v-if="menuFormData.type === 1">
                            <t-form-item :label="$t('menu.label.title.openType')" name="openType">
                        ...
                        <t-col :span="spanCol" v-if="menuFormData.type !== 2">
                            <t-form-item :label="$t('menu.label.isDisplay')" name="isDisplay">
                        ...
                        <t-col :span="spanCol" v-if="menuFormData.type !== 2">
                            <t-form-item :label="$t('menu.label.isOutside')" name="isOutside">
                        ...
                        <t-col :span="spanCol" v-if="menuFormData.type !== 2">
                            <t-form-item :label="$t('menu.label.isCache')" name="isCache">
