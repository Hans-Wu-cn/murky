...
import { refreshCache, removeSystemParameter, systemParameterPage } from '@/api/system/systemParameter';
import { SystemParameter, SystemParameterPageParams } from '@/api/system/systemParameter/types';
...
</style>@/api/system/systemParameter@/api/system/systemParameter/types