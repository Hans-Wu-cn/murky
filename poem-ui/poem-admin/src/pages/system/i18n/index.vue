...
import { i18nPage, removeI18n } from '@/api/system/i18n';
import { DictData } from '@/api/system/dict/types';
import { I18nPageParams } from '@/api/system/i18n/types';
...
const i18nTagDict = ref<DictData[]>();
...
// 加载动态字段
const loadColumns = (i18ns: DictData[]) => {
...
</style>@/api/system/i18n@/api/system/i18n/types